...
public class TourController {
    ...
    public ResponseEntity<Void>deleteTicket(@PathVariable Long tourId, UUID ticketId){
    ...
    public ResponseEntity<Map<String, UUID>>postTicket(@PathVariable Long tourId, Long flyId){
    ...
    public ResponseEntity<Void>deleteReservation(@PathVariable Long tourId, UUID reservationId){
